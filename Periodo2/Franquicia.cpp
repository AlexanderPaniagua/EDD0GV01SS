//Carlos Alexander Paniagua Diaz PD100215
...
int busquedaBinaria(array<string, SIZE> &arr, string valor) { // Implemente la funci�n b�squeda binaria, para devolver el �ndice en // el que se encuentra el valor o -1 si este no existe en el arreglo }
void buscarFranquicia() {
string franquicia;
int posicion;
cin.clear();
